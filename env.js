...
const BUNDLE_ID = "com.ecoquest"; // ios bundle id
const PACKAGE = "com.ecoquest"; // android package name
const NAME = "ecoQuest"; // app name
const EXPO_ACCOUNT_OWNER = "haochen06"; // expo account owner
const EAS_PROJECT_ID = "3b413900-54f8-48be-b225-63346136dfde"; // eas project id
const SCHEME = "ecoQuest"; // app scheme
